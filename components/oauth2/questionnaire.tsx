  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-muted-foreground">
            {SECTION_LABELS[currentSection].emoji}{" "}
            {SECTION_LABELS[currentSection].title}
          </span>
          <span className="text-sm text-muted-foreground">
          ...
          {currentQuestion.type === "closed" ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground">
                Scrivi liberamente, più dettagli condividi meglio sarà il
                matching.
              </p>
            </div>
          )}
      ...
      <div className="flex items-center justify-between">
        <Button variant="ghost" onClick={goPrev} disabled={isFirstQuestion}>
